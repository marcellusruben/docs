...
> _Message: "We are experiencing 'InsufficientCapacityError' when trying to launch a SageMaker endpoint in a eu-central-1 region with ml.g5.12x large instance.”_                       Find the "Outage Template" document in Google Docs and read its content. Then, reformat the outage notification above according to the template. Finally, write me the reformatted message here.*
> 
